...
class ADMIN
{
        ...
        public function sendOtp($otp, $email){
            if($email == NULL){
                ...
                echo "<script>alert('We have sent the OTP to $email'); window.location.href = '../../../verify-otp.php';</script>";
            ...
            if($otp == $_SESSION['OTP']){
                ...
                <body>
                    <div class='container'>
                        ...
                        <p>Welcome to Vergara Systems</p>
                ...
                if($stmt->rowCount() == 1){
                    if($userRow['status'] == "active"){
                        if($userRow['password'] == md5($password)){
                            $activity = "Has Successully signed in";
                            $user_id = $userRow['id'];
        ...
        public function adminSignout()
        {
            ...
            echo "<script>alert('Sign Out Successful'); window.location.href = '../../../';</script>";
            exit;
        }
